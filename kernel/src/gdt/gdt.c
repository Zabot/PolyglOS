...
void initalizeGDT(int cpus) {
  ...
  gdt[GDT_INDEX_KERNEL_CODE].access =
      GDT_ACCESS_PRESENT | GDT_ACCESS_CODE_SEGMENT | GDT_ACCESS_RW_ENABLE;

  gdt[GDT_INDEX_KERNEL_DATA].access =
      GDT_ACCESS_PRESENT | GDT_ACCESS_DATA_SEGMENT | GDT_ACCESS_RW_ENABLE;

  // User mode code and data
  gdt[GDT_INDEX_USER_CODE].access = GDT_ACCESS_PRESENT | GDT_ACCESS_RING_3 |
                                    GDT_ACCESS_CODE_SEGMENT |
                                    GDT_ACCESS_RW_ENABLE;

  gdt[GDT_INDEX_USER_DATA].access = GDT_ACCESS_PRESENT | GDT_ACCESS_RING_3 |
